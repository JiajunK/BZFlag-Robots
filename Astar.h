...
class AStarGraph {
public:
	//error resolved(finalProj): removed extra qualification AStarGraph:: on AStarGraph()
	AStarGraph() {}
...
private:
	...
	//error resolved(finalProj): removed extra qualification AStarGraph:: on addToQueue()
