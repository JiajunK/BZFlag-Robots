...
namespace aicore
{
	...
	*/
	...
	public:
        ...
        //new decision added (finalProj): assigning roles capture or defend
        static DecisionPtr assignRoleDecisions[3];
        ...
        //new actions added (finalProj): actions for capture/defend roles
